        ...
        <footer>
            <div className="footer-wrapper">
                <div className="footer-information">
                    <ul className="navs">
                        <li className="navs--item">
                            <p className="title"><b>Покупателям</b></p>
                            <nav className="nav">
                                <ul>
                                    <li>
                        ...
                        <li className="navs--item">
                            <p className="title"><b>Продавцам и партнёрам</b></p>
                            <nav className="nav">
                                <ul>
                                    <li>
                                        <a href="#">Продавать товары</a>
                                    </li>
                                    <li>
                        ...
                        <li className="navs--item">
                            <p className="title"><b>Наши проекты</b></p>
                            <nav className="nav">
                                <ul>
                                    <li>
                                        <a href="#">WB Guru</a>
                        ...
                        <li className="navs--item">
                            <p className="title"><b>Компания</b></p>
                            <nav className="nav">
                                <ul>
                                    <li>
                                        <a href="#">О нас</a>
                ...
                <div className="footer-social">
                    <img src="src/assets/qr-code.svg" alt="qr-code" className="qr-code"/>
                    <nav>
                            ...
                            <li>
                                <a href="#" className="vk">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="12" fill="none">
                                        <path fill="#868695"
                                              d="M10.893 12C4.06 12 .163 7.495 0 0h3.423c.112 5.502 2.636 7.832 4.634 8.312V0h3.223v4.745c1.974-.204 4.048-2.367 4.748-4.745h3.223a8.976 8.976 0 0 1-1.544 3.43 9.383 9.383 0 0 1-2.841 2.552 9.813 9.813 0 0 1 3.238 2.48A9.365 9.365 0 0 1 20 12h-3.548a5.912 5.912 0 0 0-1.913-2.895 6.29 6.29 0 0 0-3.259-1.393V12h-.387Z"/>
                                    </svg>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#" className="yt">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path fill="#868695"
                                              d="M0 6.755c0-3.062 0-4.593.893-5.59a3.5 3.5 0 0 1 .272-.272C2.162 0 3.693 0 6.755 0h6.49c3.062 0 4.593 0 5.59.893.096.085.186.176.272.272.893.997.893 2.528.893 5.59v.49c0 3.062 0 4.593-.893 5.59a3.49 3.49 0 0 1-.272.272c-.997.893-2.528.893-5.59.893h-6.49c-3.062 0-4.593 0-5.59-.893a3.495 3.495 0 0 1-.272-.272C0 11.838 0 10.307 0 7.245v-.49Z"/>
                                        <path fill="#fff" d="m13.135 7.031-5.25-3.03v6.061l5.25-3.03Z"/>
                                    </svg>
                                </a>
                            </li>
                        </ul>
